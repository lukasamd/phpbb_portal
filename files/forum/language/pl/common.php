...
$lang = array_merge($lang, array(
	...
	'G_BOTS'					=> 'Boty',
	'G_GUESTS'					=> 'Goście',
	'G_REGISTERED'				=> 'Użytkownicy',
	'G_REGISTERED_COPPA'		=> 'Użytkownicy (COPPA)',
	'G_GLOBAL_MODERATORS'		=> 'Moderatorzy',
	...
	'TOTAL_TOPICS_OTHER'=> 'Liczba tematów: <strong>%s</strong>',
	...
	'GYM_LINKS' => 'Linki',
	'GYM_LINK' => 'Link',
	'GYM_RSS_SLIDE_START' => 'Rozpocznij przewijanie',
	'GYM_RSS_SLIDE_STOP' => 'Zatrzymaj przewijanie',
	'GYM_RSS_SOURCE' => 'Źródło',


    // www.phpBB-SEO.com SEO TOOLKIT BEGIN - Related Topics
    'RELATED_TOPICS'      => 'Podobne tematy',	



    // jQuery Quick Edit -- START
	'ADVANCED_EDIT'						=> 'Zaawansowana edycja',


    // Hide code from guest mod
    'HIDE_REG' => 'Widoczne tylko dla zarejestrowanych użytkowników.',


    // New PW Info Mod
	'PM_NEW_INFO'				=> 'Masz nowe wiadomości - kliknij aby je przejrzeć',
    
    
    
    // nanothree - users viewing topic mod
    'BROWSING_TOPIC'		=> 'Użytkownicy przeglądający ten temat: %1$s',
    'BROWSING_TOPIC_GUEST'	=> 'Użytkownicy przeglądający ten temat: %1$s i %2$d gość',
    'BROWSING_TOPIC_GUESTS'	=> 'Użytkownicy przeglądający ten temat: %1$s i %2$d gości',



    // BEGIN forum counters
    'COUNTER_TOPICS'   => 'tematów',
    'COUNTER_POSTS'    => 'postów',
    'COUNTER_BROWSER'    => 'przeglądający',
    'COUNTER_BROWSERS'    => 'przeglądających',
    
    
    //-- Forum minimum posts
    'FORUM_LOW_POSTCOUNT'		=> 'Nie masz wystarczającej ilości postów aby zobaczyć ten dział.',
    'TOPIC_LOW_POSTCOUNT'		=> 'Nie masz wystarczającej ilości postów aby zobaczyć ten temat.<br />Minimalna wymagana ilość postów wynosi: 10.',


    //-- Forum reputation restriction
    'FORUM_LOW_REPUTATION'		=> 'Użytkownicy z negatywną reputacją nie mają dostępu do tego działu.',
    'TOPIC_LOW_REPUTATION'		=> 'Użytkownicy z negatywną reputacją nie mają dostępu do tego tematu.',
    
    'MCHAT_TITLE'				=> 'Shoutbox',
	'UCP_CAT_MCHAT'		=> 'Shoutbox',
	'UCP_MCHAT_CONFIG'	=> 'Ustawienia',
    
    
    // Top
    'TOP_GOOD_DAY'  => 'Dzień dobry',
    'TOP_GOOD_NIGHT'  => 'Dobry wieczór',
    'TOP_LOGOUT' => 'Wyloguj',
    'TOP_SETTINGS' => 'Ustawienia',
    'TOP_MESSAGES' => 'Wiadomości',
    
    // Bottom
    'BOTTOM_RULES' => 'Regulamin',
    'BOTTOM_MOBILE_ON' => 'Wersja mobilna',
    'BOTTOM_MOBILE_OFF' => 'Wersja standardowa',
));
