...
$lang = array_merge($lang, array(
	...
	'STATS_BASIC_MISCELLANEOUS'		=> 'Pozostałe',
	...
	'STATS_PERIODIC'					=> 'Statystki Czasowe',
	'STATS_PERIODIC_DAILY'				=> 'Statystyki Dzienne',
	'STATS_PERIODIC_MONTHLY'			=> 'Statystyki Miesięczne',
	'STATS_PERIODIC_HOURLY'			=> 'Statystki Godzinowe',
	'STATS_SETTINGS'					=> 'Statystyki Ustawień',
	'STATS_SETTINGS_BOARD'				=> 'Ustawienia Forum',
	'STATS_SETTINGS_PROFILE'			=> 'Ustawienia profilu',
	'STATS_ADDONS'					=> 'Dodatki',
	'STATS_ADDONS_MISCELLANEOUS'		=> 'scapegoat', // do not change
	
	'LOG_STATS_CONFIG_SETTINGS'				=> '<strong>Statystyki phpBB: Zmieniono Ustawienia główne</strong>',
	'LOG_STATS_CONFIG_ADDONS'				=> '<strong>Statystyki phpBB: Zmieniono Ustawienia dodatków</strong>',
	'LOG_STATS_ADDON_REMOVED'				=> '<strong>Statystyki phpBB: Usunięto dodatek %1$s</strong>',
	'LOG_STATS_ADDON_ENABLED'				=> '<strong>Statystyki phpBB: Włączono dodatek %1$s</strong>',
	'LOG_STATS_ADDON_DISABLED'				=> '<strong>Statystyki phpBB: Wyłączono dodatek %1$s</strong>',
	
	'FIELD_STATS_SHOW'					=> 'Pokazuj to pole profilu na stronie Statystyk Forum',
	'FIELD_STATS_SHOW_EXPLAIN'					=> 'Włączenie tej opcji spowoduje, że własne pole profilu będzie wyświetlane jako statystka w statystykach Ustawień Profilu na stronie Statystyk Forum. Uwaga: wyłączone albo ukryte pole nie będzie wyświetlane na stronie statystyk nawet jeśli to pole jest włączone.<br />Wyświetlanie tej statystki będzie zależne od typu danych, które to pole przechowuje.',
	
	'acl_u_view_stats'		=> array('lang' => 'Mogą przeglądać Statystyki', 'cat' => 'misc'),
...
// BEGIN reputation MOD
$lang = array_merge($lang, array(
	// Prune Feature
	'LOG_REPUTATION_DELETE'	=> '<strong>Usunięto punkt reputacji</strong>',
));
