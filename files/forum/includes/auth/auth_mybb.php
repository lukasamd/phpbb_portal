...
*
* This auth plugin is meant for users who have converted from myBB to phpBB3.
*
* @package login
...
* Login function
*/
function login_mybb(&$username, &$password)
{
	global $db, $config;
	...
	{
		if (md5(md5($row['user_passwd_salt']).md5($password)) == $row['user_password'] || md5($password) == $row['user_password'])
		{
